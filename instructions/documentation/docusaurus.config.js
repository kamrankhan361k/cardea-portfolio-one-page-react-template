...
const config = {
  title: 'Cardea React Template',
  tagline: 'Cardea react version documentation',
  ...
  baseUrl: '/cardea-react-docs/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'cocobasic', // Usually your GitHub org/user name.
  projectName: 'cardea-react-template', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Cardea React, All right reserved.`,
      },
      prism: {
